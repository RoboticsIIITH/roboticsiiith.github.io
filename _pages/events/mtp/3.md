...
As a part of this project, IIIT Hyderabad organized the Third Master Trainer Program (MTP) for the Technology Specific Work Theme "Allied UAS Technologies" for five days from 11/03/2024 to 15/03/2024.

The program included sessions on simulators for drones (ROS, MUJOCO), flight controllers, Navigation-Guidance and Control for UAV, image processing, and planning.
